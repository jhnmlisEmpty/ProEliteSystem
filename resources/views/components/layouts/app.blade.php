    ...
    <nav class="bg-gray-900 shadow-lg sticky top-0 z-50" x-data="{ mobileMenuOpen: false, userMenuOpen: false }">
            ...
            <div class="flex items-center justify-between h-16">
                ...
                <div class="flex items-center">
                    <a href="/" class="flex items-center space-x-2">
                        ...
                        <div>
                            <span class="text-md font-bold text-yellow-400 italic tracking-tight block">PRO ELITE SYSTEM - {{ optional(Auth::user()->branch)->name ?? 'No Branch' }}</span>
                        </div>
                    </a>
                </div>
                ...
                <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-4">
                        ...
                        <a href="{{ route('orders.create') }}" 
                           class="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium transition {{ request()->is('orders/create') ? 'bg-gray-700 text-white' : '' }}">
        ...
        <div class="md:hidden" x-show="mobileMenuOpen" style="display: none;">
            <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                ...
                <a href="{{ route('orders.create') }}" class="text-gray-300 hover:bg-gray-700 hover:text-white block px-3 py-2 rounded-md text-base font-medium {{ request()->is('orders/create') ? 'bg-gray-700 text-white' : '' }}">
                    <x-heroicon-o-plus class="w-5 h-5 inline-block mr-1" />
                    Create Order
                </a>
                @if(Auth::user()?->role !== 'order_creator')
                ...
                <div class="px-3 py-2">
                    <p class="text-gray-300 text-sm font-medium mb-2">{{ optional(Auth::user()->branch)->name ?? 'Overall' }}</p>
