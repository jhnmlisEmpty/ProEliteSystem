                            ...
                            <div class="bg-gradient-to-br from-blue-50 to-blue-100 p-4 rounded-lg border border-blue-200 mt-4">
                                ...
                                @else
                                    <div class="space-y-3">
                                        ...
                                        {{-- Note --}}
                                        <!-- <div>
                                            <label class="block text-xs font-medium text-blue-900 mb-1">Note (Optional)</label>
                                            <textarea wire:model="paymentNote" placeholder="Reference number, notes..." rows="2" class="w-full px-3 py-2 border border-blue-300 text-sm focus:outline-none focus:border-blue-500 rounded bg-white"></textarea>
                                        </div> -->
